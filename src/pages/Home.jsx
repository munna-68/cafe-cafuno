        ...
        <div className="bento__inner">
          ...
          <div className="bento__grid">
            ...
            <a href="/menu" className="bento__item bento__item--cta">
              ...
              <svg className="bento__cta-icon" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M18.2625 13.5l-18.2625 0 0-3 18.2625 0-8.4-8.4 2.1375-2.1 12 12-12 12-2.1375-2.1 8.4-8.4 0 0" fill="#fcf9f8" />
              </svg>
            </a>
          </div>
        </div>
